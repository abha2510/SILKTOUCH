        ...
        <Box className="m-left">
          ...
          <Card className='brand' bg={'whiteAlpha.900'}>
            ...
            <Box className='checkbox' mt="-2rem">
              <Checkbox onChange={() => { filter('Usha') }}>Olay</Checkbox>
              <Checkbox onChange={() => { filter('Philips') }}>Ponds </Checkbox>
              <Checkbox onChange={() => { filter('Kelvinator') }}>Blue Heaven </Checkbox>
              <Checkbox onChange={() => { filter('BPL') }}>Ads Beauty </Checkbox>
            </Box>
          </Card>
            ...
            <Box className="details" h="auto">
              {arr.map((el)=>(
                <Card key={el.id} h={['80vh']} mt={["0.5rem","1rem","1.5rem","2rem"]}>
                  ...
                  <TbHeartMinus size="1.6rem" marginRight="2px" border="5px solid black"/>
                  </Box>
                  ...
                  <Modal isOpen={isOpen} onClose={onClose}>
                    <ModalContent>
                      ...
                      <ModalCloseButton />
                      <ModalBody>
                        <Text><b>Do You Want To remove This Item from Your Wish List?</b></Text>
                      </ModalBody>
                      ...
                      <ModalFooter>
                        ...
                        <Button variant='ghost' onClick={() => { wishRemove(el) }}>Remove</Button>
                      </ModalFooter>
                    </ModalContent>
                  </Modal>
