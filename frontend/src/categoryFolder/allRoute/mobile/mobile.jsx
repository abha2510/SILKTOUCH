        ...
        <Box className="m-left">
          ...
          <Card className='brand' bg={'whiteAlpha.900'}>
            ...
            <Box className='checkbox' mt="-2rem">
              <Checkbox onChange={() => { filter('Usha',"Mobiles") }}>Usha </Checkbox>
              <Checkbox onChange={() => { filter('Philips',"Mobiles") }}>Philips </Checkbox>
              <Checkbox onChange={() => { filter('Kelvinator',"Mobiles") }}>Kelvinator </Checkbox>
              <Checkbox onChange={() => { filter('BPL',"Mobiles") }}>BPL </Checkbox>
            </Box>
          </Card>
          ...
          <Card className='brand' bg={'whiteAlpha.900'}>
            ...
            <Box className='checkbox' mt="-2rem">
              <Checkbox onClick={() => { filter('Usha',"Mobiles") }}>20% - 25% </Checkbox>
              <Checkbox onClick={() => { filter('Philips',"Mobiles") }}>25% - 30%</Checkbox>
              <Checkbox onClick={() => { filter('Kelvinator',"Mobiles") }}>30% - 35% </Checkbox>
              <Checkbox onClick={() => { filter('BPL',"Mobiles") }}>35% - 40% </Checkbox>
            </Box>
          </Card>
        </Box>
          ...
          <Card border="1px solid black" h={["7vh","10vh","12vh",'15vh']} p={["0.5rem","1rem","1.5rem",'2rem']}fontSize={["8px","12px","16px",'18x']}>
            <Flex>
              <Box w="50%">
                ...
                <Text className='text' onClick={()=>asc("Mobiles")}>Price(Low-High) </Text> 
                <Text className='text' onClick={()=>desc("Mobiles")}>Price(High-Low)</Text>
